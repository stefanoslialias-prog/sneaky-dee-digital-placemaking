-- Clear all raw user data again while preserving configuration
-- This will remove any new survey responses, engagement tracking, user interactions, etc.
-- that were created after the previous data clearing
